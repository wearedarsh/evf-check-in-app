import { Alert, Image, ImageBackground, Keyboard, KeyboardAvoidingView, Platform, Text, TouchableWithoutFeedback, View } from 'react-native';
				...
				<TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
					...
					>
						<View className="flex-1 justify-center items-center px-6">
							...
							<Button label={brand.copy.login.button} onPress={() => router.push('/courses')} />
						</View>
					</KeyboardAvoidingView>
